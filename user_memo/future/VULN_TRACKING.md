...
| 编号 | 来源 | 判定 |
|------|------|------|
| CVE-2025-7909 | VulDB | D-Link DIR-513 EOL 设备 → ⬜ 不适用 |
| CVE-2026-1687 | VulDB | Tenda HG10 厂商 CGI → ⬜ 不适用 |
| VulDB-38805 | VulDB | = CVE-2007-4915 → ⬜ 不适用（已有） |

---

**全部 12 项已评估完毕。** 4 ⬜ + 2 🔄 + 3 🔴 + 3 ⬜ = 12/12。
